        ...
        switch (dtoTypeString.toUpperCase(Locale.ROOT)) {
            case "FULL":
                return UserDTO
                    ...
                    .nextDate(LocalDate.ofInstant(user.getNextDate(), ZoneId.of(applicationProperties.getTime().getZone())).format(DateTimeFormatter.ofPattern(applicationProperties.getTime().getDateFormat())).toString())
