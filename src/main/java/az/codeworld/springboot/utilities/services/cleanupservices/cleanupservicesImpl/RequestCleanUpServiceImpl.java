...
import az.codeworld.springboot.utilities.services.cleanupservices.RequestCleanUpService;
...
public class RequestCleanUpServiceImpl implements RequestCleanUpService {
    ...
    private Logger log = LoggerFactory.getLogger(RequestCleanUpServiceImpl.class);

    private final RequestRepository requestRepository;

    public RequestCleanUpServiceImpl(
